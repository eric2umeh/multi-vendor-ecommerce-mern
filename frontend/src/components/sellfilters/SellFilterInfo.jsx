  ...
  return (
    <div className="sell-fill-group" key={user._id}>
        ...
        <div className="sell-fill-body">
            ...
            {existUser && sellerExists ? (<span onClick={() => handlerUnfollow(user)} className='unfollow'>Unfollow</span>) : (<span key={user._id} onClick={handlerFollow} className='follow'>Follow</span>)}
